...
// OFT Configuration for Mainnet Networks
...
// Note: Using VANAR_V2_TESTNET endpoint (40298) which represents Vana's mainnet
        ...
        { 
            ...
            config: { 
                ...
                sendConfig: { 
                    ...
                    ulnConfig: { 
                        confirmations: 20, 
                        requiredDVNs: ["0xD56e4eAb23cb81f43168F9F45211Eb027b9aC7cc", "0xfD6865c841c2d64565562fCc7e05e619A30615f0"], 
                        optionalDVNs: [], 
        ...
        { 
            ...
            config: { 
                ...
                sendConfig: { 
                    ...
                    ulnConfig: { 
                        confirmations: 15, 
                        requiredDVNs: ["0x589dEDbD617e0CBcB916A9223F4d1300c294236b", "0xD56e4eAb23cb81f43168F9F45211Eb027b9aC7cc"], 
                        optionalDVNs: [], 
                        optionalDVNThreshold: 0 
                    } 
                }, 

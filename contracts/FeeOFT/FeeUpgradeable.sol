...
/**
 * @title IFee
 * @notice Interface for fee functionality
 */
interface IFee {
    // errors
    error InvalidBps();
 ...
 * @notice Implements fee configuration and calculation for upgradeable contracts
 */
abstract contract FeeUpgradeable is IFee, Initializable, OwnableUpgradeable {
    ...
    // keccak256(abi.encode(uint256(keccak256("oort.storage.fee")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant FEE_STORAGE_LOCATION = 0x1cb173d183337e25fab6cb85705c15aad6a58cb1d552ed71b9bc628c8a3de800;
